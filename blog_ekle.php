...
<?php 
    ...
    $alt_baslik = htmlspecialchars($_POST["baslik"], ENT_QUOTES, 'UTF-8');
    $aciklama = htmlspecialchars($_POST["açıklama"], ENT_QUOTES, 'UTF-8');
    $aktif = htmlspecialchars($_POST["aktif"], ENT_QUOTES, 'UTF-8');

    $ekle = $conn->("INSERT INTO 'blog'('baslik','alt_baslik','açıklama','aktif') VALUES (:baslik,:alt_baslik,:açıklama,:aktif)");
    $ekle->bindvalue(":baslik", $baslik, PDO::PARAM_STR);
    $ekle->bindvalue(":alt_baslik", $alt_baslik, PDO::PARAM_STR);
    $ekle->bindvalue(":açıklama", $aciklama, PDO::PARAM_STR);
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="multipart/from-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="açıklama" rows="3"></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="aktif" value="0" checked>Aktif
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="aktif" value="1">Pasif
                                                </label>
                                            </div>
                                        </div>
